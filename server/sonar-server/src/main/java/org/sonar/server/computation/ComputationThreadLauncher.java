...
public class ComputationThreadLauncher implements Startable, ServerStartHandler {
  ...
  @VisibleForTesting
  ComputationThreadLauncher(ReportQueue queue, ComponentContainer sqContainer, CEContainerFactory ceContainerFactory,
  ...
  public void startAnalysisTaskNow() {
    executorService.execute(new ComputationThread(queue, sqContainer, ceContainerFactory));
  }

  @Override
  public void onServerStart(Server server) {
    executorService.scheduleAtFixedRate(new ComputationThread(queue, sqContainer, ceContainerFactory), delayForFirstStart, delayBetweenTasks, timeUnit);
  }
